...
"""Configuration file for the Brazil Data Cube Configuration Library documentation.
...
release = bdc_config.__version__
...
html_theme_options = {
    ...
    'github_url': 'https://github.com/brazil-data-cube/bdc-config',
...
html_title = 'BDC_CONFIG'

html_context = {
    'display_github': False,
    'github_user': 'brazil-data-cube',
    'github_repo': 'bdc-config',
    'last_updated': False,
}
